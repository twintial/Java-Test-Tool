...
public class MainController implements Initializable {
    ...
    public void uploadJavaFile(ActionEvent event) throws IOException {
        ...
        if (file != null) {
            ...
            // 编译
            compiler = new RunTimeJavaCompiler(file);
    ...
    // 开始测试
    public void startTest(ActionEvent event) throws Exception {
        // 生成测试数据
        ...
        // 暂定
        if (outputDirPath.getText() != null) {
            CSVUtil.writeContents(outputDirPath.getText() + File.separator + "result.csv", results);
        }
    }
